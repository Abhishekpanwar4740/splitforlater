...
import com.splitforlater.notificationservice.repository.NotificationRepository;
...
public class NotificationService {
    ...
    public void sendEmail(String toEmail, String subject, String body, UUID groupId) {
        ...
        NotificationLog notificationLog= NotificationLog.builder()
                .recipient(toEmail)
                .type(NotificationEnum.EMAIL.name())
    ...
    public void sendThrottledEmail(String userId, String email, String body,UUID groupId) {
        ...
        if (limiter.tryAcquire()) {
            ...
            sendEmail(email, "New Update", body,groupId);
        } else {
            log.warn("Notification throttled for user: {}", userId);
        }
    }
    public List<NotificationLog> getNotificationForGroup(UUID groupId,UUID requesterId) {
